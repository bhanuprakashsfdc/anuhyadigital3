  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc ml-8 mb-4">
        ...
        <li className="mb-2"><strong>Country</strong> refers to: Andhra Pradesh, India</li>
        <li className="mb-2"><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to {WEBSITE_NAME}.</li>
        ...
        <li className="mb-2"><strong>Terms and Conditions</strong> (also referred as “Terms”) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the Terms and Conditions Generator.</li>
        ...
        <li className="mb-2"><strong>Website</strong> refers to {WEBSITE_NAME}, accessible from {WEBSITE_URL} </li>
      ...
      <p className="mb-4">By email: <a href={ WEBSITE_EMAILTag }> { WEBSITE_EMAIL } </a> </p>
    </div>
 )
}
